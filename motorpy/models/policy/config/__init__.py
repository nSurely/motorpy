...
class PolicyConfigRead(PolicyConfigStandardRead):
    generation: PolicyGenerationRead = Field(
        default=PolicyGenerationRead(),
        alias="generation",
        description="""
Policy generation settings.
"""
    )
    terms: PolicyTermsRead = Field(
        default=PolicyTermsRead(),
        alias="terms",
        description="""
Policy terms and conditions.
"""
